...
import { TOP_BAR_BANNER } from '../docs/src/components/topbarBanner.config.ts'; // eslint-disable-line import/first
...
const config = {
  title: 'React Native Streamdown',
  favicon: 'img/favicon.png',

  url: 'https://docs.swmansion.com',

  baseUrl: '/react-native-streamdown/',

  organizationName: 'software-mansion-labs',
  projectName: 'react-native-streamdown',
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/software-mansion-labs/react-native-streamdown/edit/main/docs/',
          lastVersion: 'current',
          versions: {
            current: {
              label: '0.x',
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        hideOnScroll: false,
        logo: {
          alt: 'React Native Streamdown logo',
          src: 'img/logo.svg',
        ...
        items: [
          ...
          {
            href: 'https://github.com/software-mansion-labs/react-native-streamdown/',
            position: 'right',
      ...
      algolia: {
        ...
        indexName: 'react-native-streamdown',
      },
    }),
};
